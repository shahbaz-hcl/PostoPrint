...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
	...
	public static final String LOG_TAG = "ImageResults";
    ...
    public void printBaseMatrix () {
        printMatrix(mBaseMatrix);

    }

    public void printSuppMatrix () {
        printMatrix(mSuppMatrix);
    }



    public void printViewDetails() {
        Log.d( LOG_TAG, "getProperBaseMatrix. view: " + mThisWidth + "x" + mThisHeight );
    }
	...
	public void printMatrix( Matrix matrix ) {
		...
		Log.d("ImageResults", "matrix: { x: " + tx + ", y: " + ty + ", scalex: " + scalex + ", scaley: " + scaley + " }" );
	}
